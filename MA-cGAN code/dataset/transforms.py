...
class RandomResize:
    ...
    def __call__(self, img, mask):
        ...
        random_w = int(random.uniform(self.w_rank[0], self.w_rank[1])*512)
        random_h = int(random.uniform(self.h_rank[0], self.h_rank[1])*512)
        random_s = int(random.uniform(self.s_rank[0], self.s_rank[1]*20))

        print("random_w,random_h,random_s:{},{},{}".format(random_w,random_h,random_s))
